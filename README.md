[![Build Status](https://travis-ci.com/hexya-addons/mail.svg?branch=master)](https://travis-ci.com/hexya-addons/mail)
[![Go Report Card](https://goreportcard.com/badge/hexya-addons/mail)](https://goreportcard.com/report/hexya-addons/mail)
[![codecov](https://codecov.io/gh/hexya-addons/mail/branch/master/graph/badge.svg)](https://codecov.io/gh/hexya-addons/mail)
[![License: LGPL v3](https://img.shields.io/badge/License-LGPL%20v3-blue.svg)](https://www.gnu.org/licenses/lgpl-3.0)

# MAIL

Hexya Enterprise Social Network
------------------------------

Connect with experts, follow what interests you, share documents and promote
best practices with Hexya. Get work done with
...
department, don't send an email blast-post the question to Hexya and get answers
